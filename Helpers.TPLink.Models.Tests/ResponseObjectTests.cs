...
namespace Helpers.TPLink.Models.Tests
{
	public class ResponseObjectTests
	{
		...
		public void Deserialize(string json, string expectedSoftwareVersion, string expectedAlias, string expectedPhysicalAddress, int? expectedMilliamps, int? expectedMilliVolts, int? expectedMilliwatts)
		{
			var o = JsonSerializer.Deserialize<Models.Generated.ResponseObject>(json);
			Assert.NotNull(o);
