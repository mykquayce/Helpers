...
public class ExtensionTests
{
	...
	{
		var response = System.Text.Json.JsonExtensions.Deserialize<Models.ResponseObject>(json);

		Assert.NotEqual(default, response);
		Assert.NotEqual(default, response!.system);
		Assert.NotEqual(default, response.system!.get_sysinfo);
...
""", new byte[] { 208, 242, 129, 248, 139, 255, 154, 247, 213, 239, 148, 182, 209, 180, 192, 159, 236, 149, 230, 143, 225, 135, 232, 202, 240, 139, 246, 218, 248, 157, 240, 149, 225, 132, 246, 212, 238, 149, 183, 208, 181, 193, 158, 236, 137, 232, 132, 240, 153, 244, 145, 179, 137, 242, 143, 242, 143, 242, })]
	[InlineData("""
{"system":{"set_relay_state":{"state":0}}}
""", new byte[] { 208, 242, 129, 248, 139, 255, 154, 247, 213, 239, 148, 182, 197, 160, 212, 139, 249, 156, 240, 145, 232, 183, 196, 176, 209, 165, 192, 226, 216, 163, 129, 242, 134, 231, 147, 246, 212, 238, 222, 163, 222, 163, })]
	[InlineData("""
{"system":{"set_relay_state":{"state":1}}}
""", new byte[] { 208, 242, 129, 248, 139, 255, 154, 247, 213, 239, 148, 182, 197, 160, 212, 139, 249, 156, 240, 145, 232, 183, 196, 176, 209, 165, 192, 226, 216, 163, 129, 242, 134, 231, 147, 246, 212, 238, 223, 162, 223, 162, })]
	[InlineData("""
{"system":{"get_sysinfo":{}}}
""", new byte[] { 208, 242, 129, 248, 139, 255, 154, 247, 213, 239, 148, 182, 209, 180, 192, 159, 236, 149, 230, 143, 225, 135, 232, 202, 240, 139, 246, 139, 246, })]
